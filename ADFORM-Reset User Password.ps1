...
#2-It will aks to type in a new password for the user, please note that you have to verify the password (type it in twice)
#Written by KingSeifer21 System Administrator\DevOps - Last update 18-12-2017
